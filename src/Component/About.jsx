...
const About = () => {
  return (
    <Box border="2px solid rgb(224, 242, 241)" h = '100vh' id="about" className = "about section"  mb = '40px' >
        ...
        <Text  mt = '50px' fontSize={'20'}color = '#1A202C' fontWeight={500}  >Hello 👋 My self Nithin Jayaraj</Text>
        ...
        <Text mt = '15px' fontSize = '16px' fontWeight={500} id="user-detail-intro">An aspiring Full Stack Web Developer.Proficient in front-end technologies like HTML, CSS, JavaScript, React, Redux, and ChakraUI , Backend technologies Node.js,Express.js,Mongo db.A proactive problem-solver with excellent communication skills and a strong work ethic.</Text>
